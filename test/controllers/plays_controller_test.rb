...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { date_of_play: @play.date_of_play, description: @play.description, title: @play.title }
    end
  ...
  test "should update play" do
    patch :update, id: @play, play: { date_of_play: @play.date_of_play, description: @play.description, title: @play.title }
    assert_redirected_to play_path(assigns(:play))
  end
